...
export default class LineSpreader {
  ...
  private addLine(line_seg: LineSegment, line_before?: LineSegment, line_after?: LineSegment): void {
  ...
  public doConnector(connector: Connector): void {
    let prev_line_1: LineSegment = null;
    let prev_line_2: LineSegment = null;
    const iter = (line: LineSegment) => {
      if (prev_line_1) {
...
class Line {
  ...
  private end  : number;
  private line_seg    : LineSegment;
  private line_before?: LineSegment;
  private line_after ?: LineSegment;

  constructor(line_seg: LineSegment, line_before: LineSegment, line_after: LineSegment) {
